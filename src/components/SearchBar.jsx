...
export default function SearchBar() {
  const [suggestionBox, setSugestionBox] = useState([]);
  ...
  const handleOnChange = (e) => {
    ...
    setSearch(value)
    setSugestionBox(data.filter(item => 
  ...
  return (
    <div className="container">
        <input className="search-bar" value={search} type="text" onFocus={handleOnFocus} onBlur={handleOnBlur} placeholder="Search..." onChange={(handleOnChange)} />
      
        {
        show &&
      <ul className="suggestionnBox">
      {
        suggestionBox.map((sugetions) => (
        <li className="suggestions" onMouseDown={()=>{setSearch(sugetions.country) }} >
            {sugetions.country + " - " + sugetions.capital}
        </li>
        ))
      }
      </ul>
